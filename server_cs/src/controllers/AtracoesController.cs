...
namespace server_cs.src.controllers
{
    ...
    public class AtracoesController : ControllerBase
    {

        readonly Atracao AtrNotFound = new ("notFound","",[],"",[],"","","", -1);
        private readonly Atracao[] Atracoess =
        [
            new(
                    "11a24b90",
                    "Passeio de 1 dia com almoço em Angra dos Reis",
                    [
                        new IImage ("assets/images/atracao-1/1.jpg", "photo-1" ),
                        new IImage ("assets/images/atracao-1/2.jpg", "photo 2" ),
                        new IImage ("assets/images/atracao-1/3.jpg", "photo 3" ),
                        new IImage ("assets/images/atracao-1/4.jpg", "photo 4" ),
                        new IImage ("assets/images/atracao-1/5.jpg", "photo 5" ),
                    ],
                    ...
                    "Hotel Accomodare",
                    "Segunda, 13 de Abril de 2023",
                    "Início: 07:00",
                    202.33
                ),
                new(
                    "6cd29efa",
                    "Passeio ao Cristo Redentor e Pão de Açúcar",
                    [
                        new IImage ("assets/images/atracao-2/1.jpg", "photo-1" ),
                        new IImage ("assets/images/atracao-2/2.jpg", "photo 2" ),
                        new IImage ("assets/images/atracao-2/3.jpg", "photo 3" ),
                        new IImage ("assets/images/atracao-2/4.jpg", "photo 4" ),
                        new IImage ("assets/images/atracao-2/5.jpg", "photo 5" ),
                    ],
                    ...
                    "Hotel Accomodare",
                    "Segunda, 14 de Abril de 2023",
                    "Início: 07:00",
                    131.95
                ),
                new(
                    "7c14f2b5",
                    "Visita ao Estádio do Maracanã e Museu do Futebol",
                    [
                        new IImage("assets/images/atracao-3/1.jpg","photo-1" ),
                        new IImage("assets/images/atracao-3/2.jpg","photo 2" ),
                        new IImage("assets/images/atracao-3/3.jpg","photo 3" ),
                    ],
                    "Uma visita ao famoso estádio e ao museu dedicado ao futebol",
                    [
                ...
                new(
                    ...
                    images: [
                        new IImage ("assets/images/atracao-4/1.jpg","photo-1" ),
                        new IImage ("assets/images/atracao-4/2.jpg","photo 2" ),
                        new IImage ("assets/images/atracao-4/3.jpg","photo 3" ),
                    ],
                    title:
                ...
                new(
                    ...
                    images: [
                        new IImage( "assets/images/atracao-5/1.jpg", "photo-1" ),
                        new IImage( "assets/images/atracao-5/2.jpg", "photo 2" ),
                        new IImage( "assets/images/atracao-5/3.jpg", "photo 3" ),
                    ],
        ...
        public Atracao[] GetAllAtracoes()
        {
            return Atracoess;
        }

        public Atracao GetAtracaoById(string id)
        {
            Atracao? atracao;

            atracao = Array.Find(Atracoess, obj => obj.Id == id);
