...
public class AtracoesController : Controller
{
    ...
    private readonly Atracao[] Atracoes =
        [
            new(
                    "11a24b90",
    ...
    public IActionResult GetAllAtracoes()
    {
        try
        {
            var atracoes = Atracoes;
            return Ok(atracoes);
        }
        catch (Exception exception)
        {
            _logger.LogError($"Error getting all attractions: {exception.Message}");
